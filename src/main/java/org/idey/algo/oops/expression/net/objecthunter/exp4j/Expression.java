...
import org.idey.algo.oops.expression.net.objecthunter.exp4j.tokenizer.*;
...
public class Expression {
    ...
    public Expression setVariable(final String name, final Expression value) {
        return setVariable(name,value.evaluate());
    }
